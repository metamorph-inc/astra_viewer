...
if (NOT ASTRA_SDK_BUILD)
  ...
  if (ANDROID)
    ...
    set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE_OLD ${CMAKE_FIND_ROOT_PATH_MODE_INCLUDE})
  ...
  if (ANDROID)
    set(ASTRA_FIND_COMPONENTS ${ASTRA_FIND_COMPONENTS} astra_android_bridge)
  endif()
  ...
  if (ANDROID)
    ...
    set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ${CMAKE_FIND_ROOT_PATH_MODE_INCLUDE_OLD})
    unset(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY_OLD)
    unset(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE_OLD)
  endif()
endif()
